    ...
    <h1 style={styles.title}>Equipment Available</h1>
        ...
        >
          <tbody>
            ...
            <tr>
              <td>Confirm Week</td>
              <td><Button variant={addWeekColor} onClick={addWeek}>{addingButton}</Button>{' '}</td>
            </tr>

            <tr>
              <td>Confirm Booking</td>
              <td><Button variant={confirmColor} onClick={confirmBooking}>{confirmationButton}</Button>{' '}</td>
            </tr>

            <tr>
              <td>Reset Booking</td>
              <td><Button variant="danger 
              " onClick={resetStuff}>Reset Bookings</Button>{' '}</td>
            </tr>
          </tbody>
        </table>
    </div>
