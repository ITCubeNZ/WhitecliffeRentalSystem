...
// overdue SQL /////////////////////////////////////////////////////////////////////
  ...
  if (typeof firstSelectedDateUnformat === "undefined"){  // at the first if the user has not clicked on a date
      alert("Please Choose A Week")

  } else if (dating === firstDateFormated && bookingStatus === "FirstBook"){  // after user has clicked on one week, this pops up if they chose the same week as the second week  (getThatFormat === firstDateFormated)
      ...
      const secondInbetween = secondSelectedDateSlashed.replaceAll("/", "-"); 
        ...
        if (bookingStatus === "SecondBook") {  // reseting (i think)
          const resetOne = [
        ...
        else if (bookingStatus === "FirstBook"){  // second choice
        ...
        else if (bookingStatus === "NoBook") {  // first choice
...
<>
        ...
        <Modal.Body>
          ...
          <p style={{color: '#000000'}}>
            <b>Second Week To Book - : </b> {secondWeekChoice?.map((date, index) =><li >{date[0]} to {date[1]}</li>)}
          </p>
          <p style={{backgroundColor: '#212529', color: '#ffffff'}}>
            <b>Pick Up - </b> 
          </p>
    ...
    <h1 style={styles.title}>Equipment Available</h1>
        ...
        >
          <tbody>
            ...
            <tr>
              <td style={{backgroundColor: '#212529', color: '#ffffff'}}><b>Student Details</b></td>
            ...
            <tr>
              <td style={{backgroundColor: '#212529', color: '#ffffff'}}><b>Item Details</b></td>
              <td style={{backgroundColor: '#212529', color: '#ffffff'}}></td>
            </tr>
            ...
            <tr>
              <td style={{backgroundColor: '#212529', color: '#ffffff'}}><b>Booking</b></td>
              <td style={{backgroundColor: '#212529', color: '#ffffff'}}></td>
            </tr>
            ...
            <tr>
              ...
              <td>{firstWeekChoice?.map((date) => <li >{date[0]} to {date[1]}</li>)}</td>
            </tr>

            <tr>
              <td>Second Week Chosen -</td>
              <td>{secondWeekChoice?.map((date, index) =><li >{date[0]} to {date[1]}</li>)}</td>
            </tr>

            <tr>
              <td>Add The Above Week To Booking</td>
              <td><Button variant={addWeek} onClick={addBookings}>{bookingButton}</Button>{' '}</td>
            </tr>

            <tr>
              <td>Confirm Booking</td>
              <td><Button variant={confirmColor} onClick={confirmBookingsModal}>{confirmationButton}</Button>{' '}</td>
            </tr>

            <tr>
              <td>Reset Booking</td>
              <td><Button variant="danger
              " onClick={reset}>Reset Bookings</Button>{' '}</td>
            </tr>
          </tbody>
        </table>
    </div>
